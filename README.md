...
[`v4.32.0`](https://github.com/Verified-zkEVM/VCVio/tree/v4.32.0). Currently
...
Blueprint documentation and status: [Secure Messaging](https://beneficial-ai-foundation.github.io/secure-messaging/)
