...
{githubLabel}`github` {githubIssue 12}[]
::::
...
{usesLabel}`uses` {uses "cka_from_lwe_spec"}[] · {githubLabel}`github` {githubIssue 13}[]
::::
...
{usesLabel}`uses` {uses "cka_from_lwe_spec"}[] · {githubLabel}`github` {githubIssue 14}[]
::::