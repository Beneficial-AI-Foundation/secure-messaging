...
def print_html_summary(atoms: list[Atom], history_file: Path | None = None, site_dir: Path | None = None) -> None:
    ...
    print('          <li class="status-ref-item"><a class="status-ref-title" href="https://eprint.iacr.org/2025/078" target="_blank" rel="noreferrer noopener">Triple Ratchet: A Bandwidth-Efficient Hybrid-Secure Signal Protocol</a><span class="status-ref-authors">Yevgeniy Dodis, Daniel Jost, Shuichi Katsumata, Thomas Prest, Rolfe Schmidt</span><span class="status-ref-venue">EUROCRYPT 2025</span></li>')
    print('          <li class="status-ref-item"><a class="status-ref-title" href="https://eprint.iacr.org/2025/2267" target="_blank" rel="noreferrer noopener">How to Compare Bandwidth-Constrained Two-Party Secure Messaging Protocols: A Quest for a More Efficient and Secure Post-Quantum Protocol</a><span class="status-ref-authors">Benedikt Auerbach, Yevgeniy Dodis, Daniel Jost, Shuichi Katsumata, Rolfe Schmidt</span><span class="status-ref-venue">USENIX Security 2025</span></li>')
