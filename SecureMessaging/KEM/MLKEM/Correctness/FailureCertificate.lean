...
private theorem convTableTen_spec :
...
private theorem convTableEleven_spec :
...
private theorem lawPack_coefficientNoiseLaw_mlkem512 :
      ...
      (∑ x ∈ Finset.range (4 ^ 3), ∑ i ∈ Finset.range 7,
        ...
        ((∑ x ∈ Finset.range (4 ^ 2), (2 ^ 17280 : ℕ) ^ (cbdValue 2 x + 2).toNat) *
          ∑ x ∈ Finset.range modulus,
            (2 ^ 17280 : ℕ) ^ (compressionError 4 x + 104).toNat) := by
  ...
  have hAdd : lawPack (2 ^ 17280) (-106) (additiveNoiseLaw .MLKEM512) =
      (∑ x ∈ Finset.range (4 ^ 2), (2 ^ 17280 : ℕ) ^ (cbdValue 2 x + 2).toNat) *
        ∑ x ∈ Finset.range modulus, (2 ^ 17280 : ℕ) ^ (compressionError 4 x + 104).toNat := by
    rw [additiveNoiseLaw]
    simp only [ParameterSet.params]
    have h106 : (-106 : ℤ) = -2 + -104 := by norm_num
    rw [h106, lawPack_mul lawWindow_cbdLaw_two lawWindow_compressionErrorLaw_four, cbdLaw,
      compressionErrorLaw, lawPack_enumLaw, lawPack_enumLaw]
...
private theorem lawPack_coefficientNoiseLaw_mlkem768 :
    lawPack (2 ^ 21312) (-9322) (coefficientNoiseLaw .MLKEM768) =
      (∑ x ∈ Finset.range (4 ^ 2), ∑ i ∈ Finset.range 5,
        ...
        ((∑ x ∈ Finset.range (4 ^ 2), (2 ^ 21312 : ℕ) ^ (cbdValue 2 x + 2).toNat) *
          ∑ x ∈ Finset.range modulus,
            (2 ^ 21312 : ℕ) ^ (compressionError 4 x + 104).toNat) := by
  ...
  have hAdd : lawPack (2 ^ 21312) (-106) (additiveNoiseLaw .MLKEM768) =
      (∑ x ∈ Finset.range (4 ^ 2), (2 ^ 21312 : ℕ) ^ (cbdValue 2 x + 2).toNat) *
        ∑ x ∈ Finset.range modulus, (2 ^ 21312 : ℕ) ^ (compressionError 4 x + 104).toNat := by
    rw [additiveNoiseLaw]
    simp only [ParameterSet.params]
    have h106 : (-106 : ℤ) = -2 + -104 := by norm_num
    rw [h106, lawPack_mul lawWindow_cbdLaw_two lawWindow_compressionErrorLaw_four, cbdLaw,
...
private theorem lawPack_coefficientNoiseLaw_mlkem1024 :
    lawPack (2 ^ 28416) (-10294) (coefficientNoiseLaw .MLKEM1024) =
      (∑ x ∈ Finset.range (4 ^ 2), ∑ i ∈ Finset.range 5,
        ...
        ((∑ x ∈ Finset.range (4 ^ 2), (2 ^ 28416 : ℕ) ^ (cbdValue 2 x + 2).toNat) *
          ∑ x ∈ Finset.range modulus,
            (2 ^ 28416 : ℕ) ^ (compressionError 5 x + 52).toNat) := by
  ...
  have hAdd : lawPack (2 ^ 28416) (-54) (additiveNoiseLaw .MLKEM1024) =
      (∑ x ∈ Finset.range (4 ^ 2), (2 ^ 28416 : ℕ) ^ (cbdValue 2 x + 2).toNat) *
        ∑ x ∈ Finset.range modulus, (2 ^ 28416 : ℕ) ^ (compressionError 5 x + 52).toNat := by
    rw [additiveNoiseLaw]
    simp only [ParameterSet.params]
...
theorem decodeFailureMass_pow_five_le (p : ParameterSet) :
  ...
  · have hR : (2 : ℕ) ≤ 2 ^ 17280 := Nat.le_self_pow (by norm_num) 2
    ...
    rw [decodeFailureMass_eq .MLKEM512 hR hwin hden, lawPack_coefficientNoiseLaw_mlkem512,
      noiseDenominator_mlkem512, scaledFailureExponent, ringDegree]
    decide +kernel
  · have hR : (2 : ℕ) ≤ 2 ^ 21312 := Nat.le_self_pow (by norm_num) 2
    ...
    rw [decodeFailureMass_eq .MLKEM768 hR hwin hden, lawPack_coefficientNoiseLaw_mlkem768,
      noiseDenominator_mlkem768, scaledFailureExponent, ringDegree]
    decide +kernel
  · have hR : (2 : ℕ) ≤ 2 ^ 28416 := Nat.le_self_pow (by norm_num) 2
    ...
    rw [decodeFailureMass_eq .MLKEM1024 hR hwin hden, lawPack_coefficientNoiseLaw_mlkem1024,
      noiseDenominator_mlkem1024, scaledFailureExponent, ringDegree]
    decide +kernel
