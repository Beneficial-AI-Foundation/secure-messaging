...
| `gcmOneTimeAEAD_security_maxBlocks_of_irreducible` | `Irreducible nistPoly` |
...
theorem gcmOneTimeAEAD_security_maxBlocks_of_irreducible (prp : PRPScheme K (BitVec 128)) (L : ℕ)
    (hL : ValidMsgLength L)
    (adv : OneTimeCCAAdversary SupportedAAD (BitVec L) (BitVec L × BitVec 128))
    (q_d : ℕ) (hq : AEADScheme.decryptQueryBound adv q_d)
  ...
  gcmOneTimeAEAD_security_maxBlocks prp L hL adv q_d hq (ghash_isAXU L hirr)
